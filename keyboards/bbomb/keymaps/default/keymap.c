...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN2] = LAYOUT_ortho_3x3(RGB_M_P,RGB_M_B,RGB_M_R,RGB_M_SW,LT(8,RGB_TOG),RGB_M_SN,RGB_M_K,RGB_M_X,RGB_M_G),
  [_FN3] = LAYOUT_ortho_3x3(RGB_HUI,RGB_SAI,RGB_VAI,RGB_HUD,LT(8,RGB_SAD),RGB_VAD,RGB_SPI,KC_NO,RGB_SPD),
